            ...
            FileUploaded: function(up, file, response) {
                ...
                if (type == 'company-gallery'){
                    ...
                    response.forEach(function(item, i,response){
                        //alert(item.filelink);
                        var img = "<img src='" + item.filelink +"'>";
                        var ids = $(".image-id-gallery").val();
                        var str ="";
                        if(ids != ""){
                            str = ids + "_" + item.imageId;
                        }
                        else{
                            str = item.imageId;
                        }
                        $(".image-id-gallery").val(str);
                        $("#gallery").append(img);
                    });
                }
                else {

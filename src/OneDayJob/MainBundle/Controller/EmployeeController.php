...
use OneDayJob\MainBundle\Form\ProfileType;
...
//    }
    ...
    {
//        $user = $this->getUser();
//        $form = new ProfileType($user);

        return  $this->render('OneDayJobMainBundle:Employee:profileEmployee.html.twig');
...
//        $form = new ProfileType($user);
        ...
        return  $this->render('OneDayJobMainBundle:Employee:resumeEmployee.html.twig');
